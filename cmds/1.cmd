...
dbLoadRecords("$(ADPOINTGREY)/db/pointGrey.template", "P=$(PREFIX1),R=cam1:,PORT=PG1,ADDR=0,TIMEOUT=1")
dbLoadTemplate("pointGreyPG1.substitutions")
...
dbLoadRecords("$(ADCORE)/db/NDStdArrays.template", "P=$(PREFIX1),R=image1:,PORT=Image1,ADDR=0,TIMEOUT=1,NDARRAY_PORT=PG1,TYPE=Int16,FTVL=SHORT,NELEMENTS=$(NELEMENTS)")
